...
RUN unzip -q /computation/mcr_install/MCR_R2017a_glnxa64_installer.zip -d mcrtmp \
    && mcrtmp/install -destinationFolder /opt/mcr -mode silent -agreeToLicense yes \
    && rm -rf mcrtmp /computation/mcr_install/MCR_R2017a_glnxa64_installer.zip /tmp/*
...
RUN unzip -q /computation/spm_install/spm12_latest_Linux_R2017a.zip \
    && rm -rf /computation/spm_install/spm12_latest_Linux_R2017a.zip \
...
#Install med2image
RUN pip install med2image pybids
